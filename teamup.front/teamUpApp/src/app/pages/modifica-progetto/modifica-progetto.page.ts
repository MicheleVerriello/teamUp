...
export class ModificaProgettoPage {
  ...
  constructor(private navCtrl: NavController, private progettoService: ProgettoServiceService, private categoriaService: CategoriaServiceService, private router: Router, private route: ActivatedRoute) {
